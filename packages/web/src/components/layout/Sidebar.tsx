...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="h-full p-3">
      <div className="h-full bg-white dark:bg-dark-0 border border-slate-200/60 dark:border-dark-100 rounded-3xl flex flex-col overflow-hidden shadow-soft">
        ...
        <div className="flex-shrink-0 p-3 border-t border-slate-200/40 dark:border-dark-100/40 space-y-1">
          <Link
